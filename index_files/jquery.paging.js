...
!function($){
	...
	//default properties.
	var a=/a/i,defs={
		item:'li',next:'<a href=#>다음</a>',prev:'<a href=#>이전</a>',format:'<a href=#>{0}</a>',
		itemClass:'',sideClass:'',className:'pagination',
		itemCurrent:'active',length:5,max:1,current:1,append:false
		,href:'#{0}',event:true,first:'<a href=#>처음</a>',last:'<a href=#>마지막</a>'
	},format=function(str){
		var arg=arguments;
