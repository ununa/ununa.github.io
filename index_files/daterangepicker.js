  ...
  // Finally, as a browser global.
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini" type="text" name="daterangepicker_start" value="" style="width:80%;" />' +
                      '<i class="fa fa-calendar glyphicon glyphicon-calendar"></i>' +
                      '<span style="font-size:12px; margin:0px; padding:0px;" class="calendar-time">' +
                      '<div></div>' +
                        //'<i class="col-sm-2 fa fa-clock-o glyphicon glyphicon-time"></i>' +
                      '</span>' +
                    '</div>' +
                ...
                '<div class="calendar right">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" style="width:80%;" />' +
                      '<i class="fa fa-calendar glyphicon glyphicon-calendar"></i>' +
                      '<div style="font-size:12px; margin:0px; padding:0px;" class="calendar-time">' +
                      '<div></div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderTimePicker: function(side) {
            ...
            html = '<select class="hourselect" style="height:24px;">';
            ...
            html += ': <select class="minuteselect" style="height:24px;">';
